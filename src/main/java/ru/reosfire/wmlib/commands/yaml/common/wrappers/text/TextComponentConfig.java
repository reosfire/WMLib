...
public class TextComponentConfig extends YamlConfig
{
    ...
    public final ru.reosfire.wmlib.commands.yaml.common.wrappers.text.ClickConfig ClickConfig;
    public final ru.reosfire.wmlib.commands.yaml.common.wrappers.text.HoverConfig HoverConfig;
