...
public class TextComponentConfig extends YamlConfig
{
    ...
    public final ru.reosfire.WMLib.Yaml.Default.Wrappers.Text.ClickConfig ClickConfig;
    public final ru.reosfire.WMLib.Yaml.Default.Wrappers.Text.HoverConfig HoverConfig;
